...
/**
 * is_avl_helper - Checks if a binary tree is an AVL tree recursively
 * @tree: Pointer to the root node of the tree
 * @lo: Lower bound for node values
 * @hi: Upper bound for node values
 *
 * Return: 1 if the tree satisfies AVL tree conditions, 0 otherwise
 */
int is_avl_helper(const binary_tree_t *tree, int lo, int hi)
{
